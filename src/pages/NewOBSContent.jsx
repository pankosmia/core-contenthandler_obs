...
export default function NewOBSContent() {
  ...
  const handleCreate = async () => {
    ...
    if (response.ok) {
      ...
      enqueueSnackbar(
        doI18n(
          "pages:core-contenthandler_obs:content_created",
          i18nRef.current,
        ),
        { variant: "success" },
      );
      ...
      console.log("error");
      setErrorMessage(
        `${doI18n("pages:core-contenthandler_obs:book_creation_error", i18nRef.current)}: ${
          response.status
        }`,
      );
  ...
  return (
    <Box>
      ...
      <PanDialog
        titleLabel={doI18n(
          "pages:core-contenthandler_obs:create_content_obs",
          i18nRef.current,
        )}
        isOpen={open}
        closeFn={() => handleClose()}
      >
        ...
        <DialogContent spacing={2}>
          ...
          >
            <TextField
              ...
              required
              label={doI18n(
                "pages:core-contenthandler_obs:name",
                i18nRef.current,
              )}
              value={contentName}
              onChange={(event) => {
            ...
            <Tooltip
              ...
              title={doI18n(
                "pages:core-contenthandler_obs:name_is_taken",
                i18nRef.current,
              )}
              placement="top-start"
            >
              <TextField
                ...
                required
                label={doI18n(
                  "pages:core-contenthandler_obs:abbreviation",
                  i18nRef.current,
                )}
                value={contentAbbr}
                onChange={(event) => {
            ...
            <TextField
              ...
              sx={{ display: "none" }}
              label={doI18n(
                "pages:core-contenthandler_obs:type",
                i18nRef.current,
              )}
              value={contentType}
              onChange={(event) => {
        ...
        <PanDialogActions
          closeFn={() => handleClose()}
          closeLabel={doI18n(
            "pages:core-contenthandler_obs:close",
            i18nRef.current,
          )}
          actionFn={handleCreate}
          closeOnAction={false}
          actionLabel={doI18n(
            "pages:core-contenthandler_obs:create",
            i18nRef.current,
          )}
          isDisabled={
            !(
